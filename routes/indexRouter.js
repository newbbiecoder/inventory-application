...
const {createDashboard, categoryGet, addItemGet, addItemPost, deleteItemPost, updateItemsGet, updateItemsPost} = require("../controllers/createDashboard");
...
indexRouter.post("/:id/:category_id/delete", deleteItemPost)
